...
#Multi fleet 
dir_dat<-"https://www.stockassessment.org/datadisk/stockassessment/userdirs/user278/WBSS_HAWG_2024/data/" #input data directly from www.stockassessment.org
dir_fig<-"https://www.stockassessment.org/datadisk/stockassessment/userdirs/user278/WBSS_HAWG_2024/res/" #tables directly from www.stockassessment.org
...
t <- flextable(t37.2) %>%
  ...
  set_caption(
    caption = paste0(
      "TABLE 3.9.8 - WESTERN BALTIC SPRING SPAWNING HERRING. Multi fleet. Forecast table. F=F2024=0.036"
    ),
    style = "Table Caption"
  ) %>%
  colformat_num(big.mark = "", na_str = "-")
...
t <- flextable(t37.2) %>%
  ...
  set_caption(
    caption = paste0(
      "TABLE 3.9.16 - WESTERN BALTIC SPRING SPAWNING HERRING. Multi fleet. Forecast table. Constant 2024 TAC"
    ),
    style = "Table Caption"
  ) %>%
  colformat_num(big.mark = "", na_str = "-")
